...
class SettingsManager {
    ...
    static func applySettings(from source: AppSettings, to target: AppSettings) {
        ...
        target.headerFontWeight = source.headerFontWeight
        target.headerColor = source.headerColor
        target.headerFontSize = source.headerFontSize
        target.rankingFontWeight = source.rankingFontWeight
        target.rankingColor = source.rankingColor
        target.rankingFontSize = source.rankingFontSize
        target.teamNamesFontWeight = source.teamNamesFontWeight
        target.teamNamesColor = source.teamNamesColor
        target.teamNamesFontSize = source.teamNamesFontSize
        target.roundScoresFontWeight = source.roundScoresFontWeight
        target.roundScoresColor = source.roundScoresColor
        target.roundScoresFontSize = source.roundScoresFontSize
